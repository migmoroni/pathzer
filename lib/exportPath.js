...
function saveToFile(contentOutput, formatter, content) {
    const os = require('os');
    const homeDir = os.homedir();
    const saveDir = path.join(homeDir, 'pathzer', 'export');
...
function getFileNameByFormatter(formatter, nameFile) {
    switch (formatter) {
        case 0: return `${nameFile}.json`;
        case 1: return `${nameFile}.yaml`;
        case 2: return `${nameFile}.xml`;
        case 3: return `${nameFile}.txt`;
        case 4: return `${nameFile}.proto`;
        case 5: return `${nameFile}.toml`;
        case 6: return `${nameFile}.txt`;
        case 7: return `${nameFile}.txt`;
        case 8: return `${nameFile}.html`;
        case 9: return `${nameFile}.csv`; //TODO
        default: throw new Error("Formato inválido!");
    }
}
/*
