...
function importDirectoryStructure(structure, formatter, ident) {
    switch (formatter) {
        case 0: return importAsFSTree(structure);
        case 1: return importAsJSON(structure);
        case 2: return importAsYAML(structure);
        case 3: return importAsXML(structure);
        case 4: return importAsTree(structure);
        case 5: return importAsProtobuf(structure);
        case 6: return importAsTOML(structure);
        case 7: return importAsSExpression(structure);
        case 8: return importAsThrift(structure);
        case 9: return importAsHTML(structure, ident);
        case 10: return importAsCSV(structure);
        default: throw new Error("Formato inválido!");
    }
}

// Formatter 0: FSTree
function importAsFSTree(array) {
    return array;
}

// Formatter 1: JSON
function importAsJSON(jsonObject) {
